	...
	Tooltips = {
		Concept = {
			...
			PoiseDamage = ::MSU.Class.BasicTooltip(
				"Stun Power",
				::Reforged.Mod.Tooltips.parseString("Stun Power is granted by certain weapons and improved by various skills. It determines how well [stunning attacks|Concept.StunningAttack] perform.")
			),
			StunningAttack = ::MSU.Class.BasicTooltip(
				"Stunning Attack",
				::Reforged.Mod.Tooltips.parseString("A Stunning Attack subtracts the [Stun Power|Concept.PoiseDamage] for this attack from the targets [Poise|Concept.Poise] on a hit. If it reduces the targets [Poise|Concept.Poise] to 0 or below, the target will be stunned. Does not affect enemies who are immune to stuns.")
			),
