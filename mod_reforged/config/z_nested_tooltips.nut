::Reforged.NestedTooltips <- {
	Tooltips = {
		Concept = {
			...
			ParagonLevel = ::MSU.Class.BasicTooltip("Paragon Level", ::Reforged.Mod.Tooltips.parseString("The Paragon Level of a brother is the last [level|Concept.Level] where they will receive a regular [perk point|Concept.Perk] and [attribute|Concept.CharacterAttribute] roll.")),
		},
		Misc = {
