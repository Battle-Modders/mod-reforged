::Reforged.NestedTooltips <- {
	Tooltips = {
		Concept = {
			...
			Weight = ::MSU.Class.BasicTooltip("Weight", ::Reforged.Mod.Tooltips.parseString("Base Weight is a property of equippable items. The [Maximum Fatigue|Concept.MaximumFatigue] of a character is always reduced by their Weight. A characters Weight is equal to the Base Weight of all equipped items multiplied by any Weight multipliers gained from effects. The Weight of a character also influences their [Burden|Concept.Burden]")),
			Burden = ::MSU.Class.BasicTooltip("Burden", ::Reforged.Mod.Tooltips.parseString("The current [Initiative|Concept.Initiative] of a character is always reduced by their Burden. A characters Burden is equal to the [Weight|Concept.Weight] of all equipped items multiplied by any Burden multipliers gained from effects.")),
		}
	},
	AutoConcepts = [
