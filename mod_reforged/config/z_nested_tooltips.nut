...
local dummyItemContainer = ::new("scripts/items/item_container");
::Reforged.NestedTooltips <- {
	Tooltips = {
		Concept = {
			...
			BagSlots = ::MSU.Class.BasicTooltip("Bag Slots", ::Reforged.Mod.Tooltips.parseString("Bag slots can be used to store additional weapons or utility items for use during combat. Every character has " + dummyItemContainer.getUnlockedBagSlots() + " bag slots by default and can have a maximum of " + ::Const.ItemSlotSpaces[::Const.ItemSlot.Bag] + ".")),
		},
		Misc = {
