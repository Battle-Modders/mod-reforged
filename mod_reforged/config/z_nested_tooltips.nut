::Reforged.NestedTooltips <- {
	Tooltips = {
		Concept = {
			...
			Weight = ::MSU.Class.BasicTooltip("Weight", ::Reforged.Mod.Tooltips.parseString("Weight is a property of equippable items. The [Maximum Fatigue|Concept.MaximumFatigue] and current [Initiative|Concept.Initiative] of a character are reduced by their equipped items\' Weight multiplied by any multipliers gained from perks, effects etc.")),
		}
	},
	AutoConcepts = [
