::Reforged.NestedTooltips <- {
	Tooltips = {
		Concept = {
			...
			BagSlots = ::MSU.Class.BasicTooltip("Bag Slots", ::Reforged.Mod.Tooltips.parseString("Bagslots can be used to store additional weapons or utility items for use during combat. Every character has 2 Bagslots by default and can have at most 4 Bagslots.")),
		},
		Misc = {
