...
::Reforged.Items.makeWeaponLoaded <- function( o )
{
	...
	// TODO: Add a case for when this does not exist yet. Unfortunately Modern Hooks is picky about this
	...
	o.onCombatFinished <- function()
	{
		...
		if (oldIsLoadedResult)	// We reimburse the ammunitioncost in the weapon if it was loaded
		{
			::World.Assets.addAmmo((this.m.LoadedAmmunitionItem == null) ? 1 : this.m.LoadedAmmunitionItem.getAmmoCost());
		}
		this.setLoaded(false);	// We always unload the weapon
