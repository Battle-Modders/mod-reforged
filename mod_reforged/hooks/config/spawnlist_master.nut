...
::MSU.Table.merge(::Const.World.Spawn.Troops, {
	...
	RF_KnightAnointed = {
		...
		NameList = null, // We keep it null here because we generate the name directly in rf_knight_anointed instead of having to always keep in memory a KnightAnointed names array
		TitleList = null
	},
	RF_Squire = {
