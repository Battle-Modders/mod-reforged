...
::Const.TipOfTheDay.extend([
	...
	"Enemies will only drop loot if your faction has dealt at least 50% of the total damage received by that enemy.",
	"Experience from slain enemies is awarded depending on how much damage was dealt to them by your brothers."
