	...
	RF_FollowUp = ::UPD.getDescription({
 		...
 		Effects = [{
			...
			Description = [
				...
				"The damage dealt reduced by " + ::MSU.Text.colorRed("30%") + " for the first attack and by an additional " + ::MSU.Text.colorRed("10%") + " for every further attack up to a maximum of " + ::MSU.Text.colorRed("90%"),
