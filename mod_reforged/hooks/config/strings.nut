		...
		Description = ::UPD.getDescription({
	 		Effects = [{
 				...
 				Description = [
					...
					"When used on an adjacent target, reduces its [Melee Defense|Concept.MeleeDefense] and [Ranged Defense|Concept.RangeDefense] by " + ::MSU.Text.colorGreen("20%") + " of the user's [Resolve|Concept.Resolve]."
				]
 			}]
	 	}),
	},
