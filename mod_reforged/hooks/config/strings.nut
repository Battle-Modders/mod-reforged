...
::MSU.Table.merge(::Const.Strings.PerkDescription, {
	...
	RF_Unstoppable = ::UPD.getDescription({
 		...
 		Effects = [{
			Type = ::UPD.EffectType.Passive,
			Description = [
				"Whenever you end your [turn|Concept.Turn] with half or less of your [Action Points|Concept.ActionPoints] remaining, gain a stack, up to a maximum of 5 stacks.",
				...
				"All the stacks are lost if you use Wait or [Recover|Skill+recover_skill], or get [Stunned|Skill+stunned_effect], Rooted or [Staggered|Skill+staggered_effect]."
			]
		}]
 	}),
