		...
		Description = ::UPD.getDescription({
	 		Effects = [{
 				...
 				Description = [
					...
					"When used on an adjacent target, reduce its [Melee Defense|Concept.MeleeDefense] and [Ranged Defense|Concept.RangeDefense] by " + ::MSU.Text.colorGreen("20%") + " of the users [Resolve|Concept.Resolve]."
				]
 			}]
	 	}),
	},
