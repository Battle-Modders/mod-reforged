...
::MSU.Table.merge(::Const.Strings.PerkDescription, {
	...
	RF_EnGarde = ::UPD.getDescription({
 		...
 		Effects = [{
			...
			Description = [
				...
				"If your weapon does not have [Riposte|Skill+riposte] and is two-handed, gain the [Return Favor|Skill+return_favor_effect] effect instead until the start of your next [turn|Concept.Turn].",
	...
	RF_Poise = ::UPD.getDescription({
 		...
 		Effects = [{
			Type = ::UPD.EffectType.Passive,
			Description = [
				"Damage from attacks to [Hitpoints|Concept.Hitpoints] is reduced by " + ::MSU.Text.colorGreen("30%") + " and that to armor by " + ::MSU.Text.colorGreen("15%") + ".",
				"The bonus drops exponentially when wearing head and body armor with a total a total [Base Weight|Concept.Weight] above 35.",
