 		...
 		Effects = [
 			{
 				Type = ::UPD.EffectType.Passive,
 				Description = [
 					"Enemies netted by you have a " + ::MSU.Text.colorRed("50%") + " increased [Action Point|Concept.ActionPoints] cost for using the [Break Free|Skill+break_free_skill] skill."
 				]
 			},
 			{
 				Type = ::UPD.EffectType.Active,
 				Description = [
 					"Unlocks the [Net Pull|Skill+rf_net_pull_skill] skill that allows you to pull a target and net it."
 				]
 			}
 		]
 	}),
