			...
			Effects = [
				{
					...
					Description = [
						...
						"The [$ $|Item+longaxe] no longer have a penalty for attacking targets directly adjacent."
					]
				},
				{
					Type = ::UPD.EffectType.Active,
		...
		Description = ::UPD.getDescription({
			...
			Effects = [{
				...
				Description = [
					...
					"All skills with Polearms, or two-handed weapons with a range of 2 tiles, with an [Action Point|Concept.ActionPoints] cost of " + ::MSU.Text.colorNegative("6") + " have their [Action Point|Concept.ActionPoints] cost reduced to " + ::MSU.Text.colorNegative("5") + ".",
