		...
		Description = ::UPD.getDescription({
			...
			Effects = [{
				...
				Description = [
					...
					"Cannot be used if either character is [stunned,|Skill+stunned_effect] [rooted|Skill+rooted_effect] or otherwise disabled."
				]
			}]
		})
	},
	...
	},
	{
		...
		Description = ::UPD.getDescription({
			...
			Effects = [{
				Type = ::UPD.EffectType.Active,
				Description = [
					"Unlocks the [Rally|Skill+rally_the_troops] skill which can raise [morale|Concept.Morale] of all nearby allies of your faction to a steady level.",
		...
		Description = ::UPD.getDescription({
			...
			Effects = [{
				...
				Description = [
					...
					"When starting your [turn|Concept.Turn] with a spear equipped, the first piercing spear attack during your [turn|Concept.Turn] costs no [Action Points|Concept.ActionPoints] and builds no [Fatigue,|Concept.Fatigue] but deals " + ::MSU.Text.colorNegative("25%") + " less damage. Expires upon switching your weapon.",
		...
		Description = ::UPD.getDescription({
			...
			Effects = [{
				...
				Description = [
					...
					"The bonus drops exponentially when wearing head and body armor with a total penalty to [Maximum Fatigue|Concept.MaximumFatigue] above 15% of your [Base|Concept.BaseAttribute] [Fatigue|Concept.Fatigue] including [traits|Concept.Trait] and [permanent injuries|Concept.InjuryPermanent].",
...
::MSU.Table.merge(::Const.Strings.PerkDescription, {
	...
	RF_Blitzkrieg = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Active,
			Description = [
				"Unlocks the [Blitzkrieg|Skill+rf_blitzkrieg_skill] skill which allows you and the rest of your company to gain the [Adrenaline|Skill+adrenaline_effect] effect."
			]
		}]
	}),
	...
	RF_DentArmor = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Passive,
			Description = [
				"Successful attacks have a " + ::MSU.Text.colorPositive("66%") + " chance to apply the [Dented Armor|Skill+rf_dented_armor_effect] effect."
			]
		}]
	}),
	...
	RF_Dismantle = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Passive,
			Description = [
				"Every successful hit has a chance to apply the [Dismantled Armor|Skill+rf_dismantled_effect] effect, which causes the target to receive a stacking " + ::MSU.Text.colorNegative("+20%") + " damage received ignoring armor on the body part hit for the remainder of the combat.",
	...
	RF_FreshAndFurious = ::UPD.getDescription({
		...
		Effects = [{
			...
			Description = [
				...
				"The effect becomes disabled if you start a [turn|Concept.Turn] with " + ::MSU.Text.colorNegative("30%") + " or more [Fatigue|Concept.Fatigue] built and remains disabled until you use [Recover.|Skill+recover_skill]"
			]
		}]
	}),
	...
	RF_Poise = ::UPD.getDescription({
		...
		Effects = [{
			...
			Description = [
				...
				"The bonus drops exponentially when wearing head and body armor with a total penalty to [Maximum Fatigue|Concept.MaximumFatigue] above 35% of your [Base|Concept.BaseAttribute] [Fatigue|Concept.Fatigue] including [traits|Concept.Trait] and [permanent injuries|Concept.InjuryPermanent].",
				"Does not affect damage from mental attacks or status effects, but can help to avoid receiving them.",
				"When attacking a target against whom you have a [Reach Disadvantage,|Concept.ReachAdvantage] reduce this disadvantage by " + ::MSU.Text.colorPositive(1) + " if your [Initiative|Concept.Initiative] is greater than that of your target."
				"[Brawny|Perk+perk_brawny] does not affect this perk.",
	...
	RF_Onslaught = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Active,
			Description = [
				"Unlocks the [Onslaught|Skill+rf_onslaught_skill] skill which allows you and nearby members of your company to gain increased [Initiative,|Concept.Initiative] [Melee Skill|Concept.MeleeSkill] and one use of the [Line Breaker|Skill+rf_line_breaker_skill] skill for one [turn.|Concept.Turn] This use of [Line Breaker|Skill+rf_line_breaker_skill] has a reduced [Action Point|Concept.ActionPoints] and [Fatigue|Concept.Fatigue] cost."
			]
		}]
	}),
	...
	RF_ThroughTheGaps = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Passive,
			Description = [
				"The first attack each [turn|Concept.Turn] ignores " + ::MSU.Text.colorPositive("+10%") + " of the target\'s armor and always targets the body part with the lower armor."
			]
		}]
	}),
