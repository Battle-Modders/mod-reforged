...
::MSU.Table.merge(::Const.Strings.PerkDescription, {
	...
	RF_BetweenTheEyes = ::UPD.getDescription({
		...
		Effects = [{
			Type = ::UPD.EffectType.Active,
			Description = [
				"Unlocks the [Between the Eyes|NullEntitySkill+rf_between_the_eyes_skill] skill."
			]
		}]
	}),
