...
::Reforged.Entities.editEntity("BanditThug", // reforged thug is a different design than vanilla thug
	null,
	{
		XP = 150,
		ActionPoints = 9,
...
::Reforged.Entities.editEntity("BanditMarksman", // reforged marksman is a higher tier entity
	{
		Cost = 22, // vanilla 15
		Strength = 30 // vanilla 15
	},
	{
		XP = 275, // vanilla 225
		ActionPoints = 9,
...
::Reforged.Entities.addEntity(
	...
	"Brigand Scoundrel",
	"Brigand Scoundrels",
	"rf_bandit_scoundrel_orientation",
