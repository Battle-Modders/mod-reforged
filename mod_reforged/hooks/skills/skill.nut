::Reforged.HooksMod.hook("scripts/skills/skill", function(q) {
	...
	// Pass `_false` for `_isAttacker` when the skill user is the actor of this skill and the target is `_entity`.
	// Pass `true` for `_isAttacker` if the actor of this skill is the target and `_entity` is the attacker.
