::mods_hookExactClass("skills/actives/knock_back", function(o) {
	...
	o.onUse = function( _user, _targetTile )
	{
		...
		if (ret && targetEntity != null && targetEntity.isAlive() && !targetEntity.isDying() && this.getContainer().hasSkill("perk.shield_expert") && !_targetEntity.getSkills().has("effects.staggered"))
		{
