::Reforged.HooksMod.hook("scripts/skills/actives/barbarian_fury_skill", function(q) {
	q.create = @(__original) { function create()
	{
		...
		this.m.Description = ::Reforged.Mod.Tooltips.parseString("Switch places with an adjacent ally, provided neither you nor the ally is [$ $|Skill+stunned_effect] or rooted. Rotate the battle line to keep fresh troops in front!");
	}}.create;
