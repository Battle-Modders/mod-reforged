	...
	q.getTooltip = @() { function getTooltip()
	{
		...
		ret.extend([
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/special.png",
				text = ::Reforged.Mod.Tooltips.parseString("Has a " + ::MSU.Text.colorPositive("100%") + " chance to stun a random adjacent enemy upon arrival, reduced by the defense granted by target\'s shield and [$ $|Skill+shieldwall_effect]")
			},
			{
				id = 12,
				type = "text",
