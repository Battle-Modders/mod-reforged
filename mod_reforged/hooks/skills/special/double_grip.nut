		...
		switch (this.m.CurrWeaponType)
		{
			...
			case ::Const.Items.WeaponType.Mace:
				...
				ret.push({
					...
					text = ::Reforged.Mod.Tooltips.parseString("Hits that deal at least " + ::MSU.Text.colorDamage(::Const.Combat.MinDamageToApplyBleeding) + " damage to [Hitpoints|Concept.Hitpoints] apply the [$ $|Skill+dazed_effect] effect")
				});
				break;
