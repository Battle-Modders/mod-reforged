::Reforged.HooksMod.hook("scripts/skills/special/double_grip", function(q) {
	...
	{
		__original();
		this.m.Description = "With the second hand free, this character can adopt a more versatile fighting stile or get a firm double grip on his weapon to inflict additional damage."
	}
	...
	q.canDoubleGrip = @() function()
	{
		...
		return offhand.getStaminaModifier() < 10 && this.m.CurrWeaponType == "SouthernSword" && this.getContainer().hasSkill("perk.rf_en_garde");
	}
