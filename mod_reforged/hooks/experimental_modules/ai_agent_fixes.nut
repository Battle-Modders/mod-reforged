...
::Reforged.AgentState <- class
{
	...
	// Because many behaviors keep returning `false` several times and agent.execue continues to be called
	// agani and again until that behavior's execution is complete.
