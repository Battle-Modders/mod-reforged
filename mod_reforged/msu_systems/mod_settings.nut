...
tacticalTooltipPage.addRangeSetting("CollapseActivesWhenX", 7, 0, 20, 1, "Collapse Actives When", "While the number of active skills is below this value they display their icon and use a separate line. Otherwise they combine into a single block of text in order to save space.");
