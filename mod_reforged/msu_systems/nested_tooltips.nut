...
::Reforged.QueueBucket.FirstWorldInit.push(function() {
	...
	::MSU.Table.merge(::Reforged.NestedTooltips.Tooltips.Concept, {
		...
		HybridWeapon = ::MSU.Class.BasicTooltip("Hybrid Weapon", ::Reforged.Mod.Tooltips.parseString("Hybrid Weapons are weapons with two or more weapon types. Non-Hybrid Weapons have only one weapon type.")),
