this.rf_onslaught_skill <- ::inherit("scripts/skills/skill", {
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = ::Reforged.Mod.Tooltips.parseString("You and your allies within " + ::MSU.Text.colorPositive(4) + " tiles gain the [$ $|Skill+rf_onslaught_effect] effect for 2 [rounds|Concept.Round]")
		});
