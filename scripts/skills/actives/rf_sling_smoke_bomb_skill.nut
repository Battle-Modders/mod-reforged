local obj = ::Reforged.InheritHelper.slingItemSkill("throw_smoke_bomb_skill");
...
this.rf_sling_smoke_bomb_skill <- ::inherit("scripts/skills/actives/throw_smoke_bomb_skill", obj);
