this.rf_dynamic_duo_shuffle_skill <- ::inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Shuffle";
		this.m.Description = ::Reforged.Mod.Tooltips.parseString("Once per turn, switch places with your partner, provided neither you nor your partner is [$ $|Skill+stunned_effect] or rooted.");
