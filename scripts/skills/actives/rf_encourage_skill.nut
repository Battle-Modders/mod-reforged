this.rf_encourage_skill <- ::inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = ::Reforged.Mod.Tooltips.parseString("Encourage an ally to raise their current [Morale|Concept.Morale]. Cannot be used on [fleeing|Concept.Morale] or [$ $|Skill+stunned_effect] allies.");
