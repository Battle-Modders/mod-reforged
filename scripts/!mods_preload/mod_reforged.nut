...
::mods_queue(::Reforged.ID, "mod_msu(>=1.3.0-reforged.5), dlc_lindwurm, dlc_unhold, dlc_wildmen, dlc_desert, dlc_paladins, mod_dynamic_perks, mod_upd, mod_stack_based_skills, !mod_legends", function() {
