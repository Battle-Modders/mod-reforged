this.rf_dodge_potion_item <- ::inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Description = "This concoction of the essence of an other-worldly spirit makes quick movements feel lighter, giving you exceptional reflexes and making it harder for your enemies to hit you. Lasts for the next battle.";
