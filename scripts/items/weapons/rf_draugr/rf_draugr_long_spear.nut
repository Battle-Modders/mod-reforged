this.rf_draugr_long_spear <- ::inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		this.m.ID = "weapon.rf_draugr_long_spear";
		this.m.Name = "Barrowkin Long Spear";
		this.m.Description = "A long two-handed thrusting blade perfect for lunging strikes.";
		this.m.IconLarge = "weapons/melee/rf_draugr_long_spear_01.png";
		this.m.Icon = "weapons/melee/rf_draugr_long_spear_01_70x70.png";
		...
		this.m.ArmamentIcon = "icon_rf_draugr_long_spear_01";
		this.m.Value = 2400;
