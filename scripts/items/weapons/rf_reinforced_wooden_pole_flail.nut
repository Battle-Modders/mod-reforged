this.rf_reinforced_wooden_pole_flail <- ::inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		this.m.ID = "weapon.rf_reinforced_wooden_pole_flail";
		this.m.Name = "Reinforced Wooden Pole Flail";
		this.m.Description = "A long-handled farmer's implement reinforced to be sturdier in battle.";
		this.m.IconLarge = "weapons/melee/rf_reinforced_wooden_pole_flail_01.png";
		this.m.Icon = "weapons/melee/rf_reinforced_wooden_pole_flail_01_70x70.png";
		...
		this.m.ArmamentIcon = "icon_rf_reinforced_wooden_pole_flail_01";
		this.m.Value = 700;
