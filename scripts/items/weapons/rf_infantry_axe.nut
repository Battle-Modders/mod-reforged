this.rf_infantry_axe <- ::inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		...
		this.m.IconLarge = "weapons/melee/goblin_weapon_05.png"; // placeholder for Infantry Axe art
		this.m.Icon = "weapons/melee/goblin_weapon_05_70x70.png"; // placeholder for Infantry Axe art
